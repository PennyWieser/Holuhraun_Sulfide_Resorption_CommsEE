...
class MeltComposition:
    ...
    def __init__(self, melt_fraction, choice):
        ...
        if choice == 1:
            ...
            sio2 = 50.27/ melt_fraction
            al2o3 = 13.23 / melt_fraction
            feot = 13.49 / melt_fraction
            mgo = 6.47 / melt_fraction
            cao = 11.01 / melt_fraction
            na2o = 2.59 / melt_fraction
            k2o = 0.24 / melt_fraction
            p2o5 = 0.19 / melt_fraction
            mno = 0.24 / melt_fraction
            tio2 = 2.08 / melt_fraction
